...
| --oracle_noise          | float                                                                                    | 0.0             | Value for oracle noise injection (probability of flipping labels randomly, uniform additive noise for constraints) |
| --use_constraint_oracle | bool                                                                                     | False           | Replace the constraint module with ground truth annotations                                                        |
| --calibrate             | bool                                                                                     | False           | Use additional temperature parameters to calibrate probabilities                                                   |
